...
The project will employ a the following German language datasets:
\begin{enumerate}
...
\begin{itemize}
    ...
    \item Whereas Tom did the majority of the writing for the proposal, Nico set up the group's github account and researched guides to facilitate the technical collaboration on that platform. 
