...
\begin{figure*}
    \begin{subfigure}[t]{0.89\textwidth}
        \centering
        \includegraphics[width=.9\linewidth]{reports/final-report-latex/eval_precision_comp(1).png} 
        \caption{Precision} \label{fig:prec_comp}
    \end{subfigure}
    \begin{subfigure}[t]{0.89\textwidth}
        \centering
        \includegraphics[width=.9\linewidth]{reports/final-report-latex/train_loss_comp(2).png} 
...
\paragraph{Appendix B} Wandb output:
\begin{figure*}
    \centering
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=1\linewidth]{reports/final-report-latex/eval_f1_comp(1).png} 
        \caption{F1-metric} \label{fig:f1_comp}
    \end{subfigure}
    \begin{subfigure}[t]{0.49\textwidth}
        \centering       \includegraphics[width=1\linewidth]{reports/final-report-latex/eval_accu_comp.png} 
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=.9\linewidth]{reports/final-report-latex/train_learning_rate.png} 
        \caption{Learning Rate} \label{fig:lr}
    \end{subfigure}
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=.9\linewidth]{reports/final-report-latex/recall_comp.png} 
...
\begin{figure*}
    \centering
    \includegraphics[width=.9\linewidth]{reports/final-report-latex/image.png}
