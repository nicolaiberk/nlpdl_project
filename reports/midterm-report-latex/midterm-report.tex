...
\paragraph{Results:} Applying model 2 (fine-tuned on party press releases) to newspaper articles 

\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{reports/midterm-report-latex/figures/preds.png}
    \caption{Performance of model 2 for the classification of newspaper articles.}
    \label{fig:party}
\end{figure}
