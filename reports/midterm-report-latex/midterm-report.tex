...
The measurement of ideology and political bias are the subject of much research on political text \cite{X,Y,Z}. However, researchers often find themselves facing a lack of appropriate training data. Manual annotation is usually costly and so it might be useful to infer ideology from other sources of text. We test this reasoning for the measurement of newspaper bias.
